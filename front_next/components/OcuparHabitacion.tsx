                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full text-center">
                        ...
                        <div className="flex gap-4 justify-center">
                            <button onClick={handleConflictCancel} className="px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 font-medium transition-colors cursor-pointer">Cancelar</button>
                            <button onClick={handleConflictProceed} className="px-4 py-2 bg-[#0056b3] text-white rounded hover:bg-blue-700 font-medium transition-colors cursor-pointer">Ocupar igual</button>
                        </div>
                    </div>
                </div>
            )}
